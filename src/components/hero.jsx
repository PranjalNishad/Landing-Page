  ...
  return (
    <main className="flex lg:mt-20 flex-col lg:flex-row items-center justify-between min-h-[calc(90vh-6rem)] ">
        ...
        <div data-aos="fade-right"
            ...
            {/* tag box  */}
            <div className="relative w-[95%] sm:w-48 h-10 bg-gradient-to-r from-[#656565] to-[#ce783b] shadow-[0_0_15px_rgba(255,255,255,0.4)] rounded-full">
            ...
            <p className="text-base sm:text-lg tracking-wider text-gray-400 max-w-[25rem] lg:max-w-[30rem]">
                the best way to reach uumas insted of spam folders, dlever transitional and marketing emails at scale.
            </p>
            ...
            <div className="flex gap-4 mt-12">
                ...
                <a className="border border-[#2a2a2a] py-2 sm:py-3 px-8 sm:px-10 rounded-full sm:text-lg text-sm font-semibold tracking-wider transition-all duration-300 hover:bg-[#1a1a1a] bg-gray-300 text-black hover:text-white " href="#">
                    GET STARTWD <i className="bx bx-link-external"></i>
                </a>
            </div>
        </div>
        ...
        <Spline data-aos="fade-zoom-in"
                ...
                scene="https://prod.spline.design/fx59Mim9cNd0uUil/scene.splinecode" 
        />
